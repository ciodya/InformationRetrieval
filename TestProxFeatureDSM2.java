...
public class TestProxFeatureDSM2 extends ApplicationSetupBasedTest
{
    @Test public void testOneDocTwoTerms() throws Exception {
        ...
        Index index = IndexTestUtils.makeIndexBlocks(
                new String[]{"doc1"},
                new String[]{"The fox quick brown jumps fox over  the lazy dog "});
        ...
        ProxFeatureDSM_2 sample2 = new ProxFeatureDSM_2();
